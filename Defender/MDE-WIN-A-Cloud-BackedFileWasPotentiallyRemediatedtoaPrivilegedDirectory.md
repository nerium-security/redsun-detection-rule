...
| Property                   | Value            |
| -------------------------- | ---------------- |
| Name                                          | GEN-MDE-052-A Cloud-Backed File Was Potentially Remediated to a Privileged Directory |
| Alert Name                                    | GEN-MDE-052-A Cloud-Backed File Was Potentially Remediated to a Privileged Directory |
...
### Detection Logic
```kusto
// Managed by Nerium Exine - Do Not Edit
// Rule file: /home/runner/work/detection-rules/detection-rules/main/rules/defender/GEN/MDE/GEN-MDE-052-A Cloud-Backed File Was Potentially Remediated to a Privileged Directory.yaml
let _span = 48h;
